...
/*
Component representing the information about a chat companion and his status of typing.
 */
		...
		return (
			<div className="chat-header clearfix">
				<div className="chat-about">
					<div id="test" className="chat-with">
						{this.getUserName()}
					</div>
					<div className='chat-user'>{this.getTypingInfo(this.props.typing)}</div>
				</div>
