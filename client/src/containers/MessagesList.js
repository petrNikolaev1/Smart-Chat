...
@connect(store => ({
        messages: store.messagesReducer,
        contextMenuMessageId: store.contextMenuOpenReducer,
        editingInfo: store.contextMenuEditReducer,
        isMarked: store.markEditedMessageReducer,
        chatControlContent: store.chatControlContentReducer,
        markedMessage: store.markedMessageReducer,
        publicTyping: store.publicTypingReducer,
        privateTyping: store.privateTypingReducer
    }), {
        handleContextMenuOpen: contextMenuOpen,
        handleContextMenuEdit: contextMenuEdit,
        handleMarkEditedMessage: markEditedMessage,
        handleChatControlContent: chatControlContent,
        handleMarkedMessage: markMessage
    }
)
